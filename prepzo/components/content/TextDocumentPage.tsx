...
export function TextDocumentPage({ title, content }: TextDocumentPageProps) {
  return (
    <main className="legal-document-page min-h-screen bg-[#F8FAFF] text-[#0F172A]">
      ...
      <article className="mx-auto max-w-4xl px-4 py-10 sm:px-6">
        <div className="legal-document-card rounded-[14px] border border-[#E2E8F0] bg-white p-5 shadow-[var(--shadow-card)] sm:p-8">
          <h1 className="mb-6 font-[family-name:var(--font-fraunces)] text-3xl font-bold text-[#0F172A]">
            {title}
          </h1>
          <pre className="legal-document-content whitespace-pre-wrap break-words font-sans text-sm leading-7 text-[#334155]">
            {content}
          </pre>
        </div>
      </article>
